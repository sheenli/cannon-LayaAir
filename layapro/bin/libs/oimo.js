...
(function(OIMO) { 'use strict';
	...
	*/
	...
	OIMO.Box = Box;
	OIMO.Sphere = Sphere;
	OIMO.Cylinder = Cylinder;
	OIMO.Plane = Plane;
	OIMO.Particle = Particle;
	OIMO.ShapeConfig = ShapeConfig;
	OIMO.LimitMotor = LimitMotor;
	OIMO.HingeJoint = HingeJoint;
	OIMO.BallAndSocketJoint = BallAndSocketJoint;
	OIMO.DistanceJoint = DistanceJoint;
	OIMO.PrismaticJoint = PrismaticJoint;
	OIMO.SliderJoint = SliderJoint;
	OIMO.WheelJoint = WheelJoint;
	OIMO.JointConfig = JointConfig;
	OIMO.RigidBody = RigidBody;
	OIMO.World = World;
	OIMO.REVISION = REVISION;
	OIMO.BR_NULL = BR_NULL;
	OIMO.BR_BRUTE_FORCE = BR_BRUTE_FORCE;
	OIMO.BR_SWEEP_AND_PRUNE = BR_SWEEP_AND_PRUNE;
	OIMO.BR_BOUNDING_VOLUME_TREE = BR_BOUNDING_VOLUME_TREE;
	OIMO.BODY_NULL = BODY_NULL;
	OIMO.BODY_DYNAMIC = BODY_DYNAMIC;
	OIMO.BODY_STATIC = BODY_STATIC;
	OIMO.BODY_KINEMATIC = BODY_KINEMATIC;
	OIMO.BODY_GHOST = BODY_GHOST;
	OIMO.SHAPE_NULL = SHAPE_NULL;
	OIMO.SHAPE_SPHERE = SHAPE_SPHERE;
	OIMO.SHAPE_BOX = SHAPE_BOX;
	OIMO.SHAPE_CYLINDER = SHAPE_CYLINDER;
	OIMO.SHAPE_PLANE = SHAPE_PLANE;
	OIMO.SHAPE_PARTICLE = SHAPE_PARTICLE;
	OIMO.SHAPE_TETRA = SHAPE_TETRA;
	OIMO.JOINT_NULL = JOINT_NULL;
	OIMO.JOINT_DISTANCE = JOINT_DISTANCE;
	OIMO.JOINT_BALL_AND_SOCKET = JOINT_BALL_AND_SOCKET;
	OIMO.JOINT_HINGE = JOINT_HINGE;
	OIMO.JOINT_WHEEL = JOINT_WHEEL;
	OIMO.JOINT_SLIDER = JOINT_SLIDER;
	OIMO.JOINT_PRISMATIC = JOINT_PRISMATIC;
	OIMO.AABB_PROX = AABB_PROX;
	OIMO.printError = printError;
	OIMO.InfoDisplay = InfoDisplay;

	Object.defineProperty(OIMO, '__esModule', { value: true });
